...
export default function OrderTableRow({ row, status,unit_enum, onCreateRow, selected, onViewRow, onSelectRow, onDeleteRow }) {
  ...
  const renderPrimary = (
    <TableRow hover selected={selected}>
      ...
      <TableCell>{row?.period_value + " " + unit_enum}</TableCell>
      <TableCell>
        <ListItemText
