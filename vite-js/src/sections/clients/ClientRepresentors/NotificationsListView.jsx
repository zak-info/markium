...
export default function ClientRepresentorsListView({ id,representors }) {
  ...
  const TABLE_HEAD = [
    ...
    { id: 'contact_number', label: t('contact_number') },
  ...
  const [tableData, setTableData] = useState(representors);
  useEffect(() => {
    setTableData(representors)
  }, [representors])
  ...
  if (name) {
    inputData = inputData?.filter(
      (order) =>
        ...
        order?.contact_number?.toLowerCase()?.includes(name.toLowerCase())
    );
  }
