...
export default function ContractClaimsListView({ id,claims }) {
                ...
                {dataFiltered
                  ...
                  .map((row) => (
                    <OrderTableRow
                      key={row?.id}
                      row={row}
                      clausable={row?.clauseable_type == "car" ? car?.find(item => item?.id == row?.clauseable_id) : drivers?.find(item => item?.id == row?.clauseable_id)}
