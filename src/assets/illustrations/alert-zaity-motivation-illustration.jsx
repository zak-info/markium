...
import ErrorBackgroundShape from './error-background-shape';
...
function MotivationIllustration({ ...other }) {
  ...
  const PRIMARY_LIGHTER = theme.palette.error.lighter;

  const PRIMARY_DARK = theme.palette.error.dark;

  const PRIMARY_DARKER = theme.palette.error.darker;
